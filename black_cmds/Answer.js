...
zokou({
  ...
  try {
    ...
    _0x338749.sendMessage(_0x2c97cc, {
      ...
      'caption': "*POWERED BY 𝔹𝕃𝔸ℂ𝕂ℍ𝔸ℂ𝕂𝔼ℝ𝕊*"
    }, {
      'quoted': _0x3ce799
    });
  } catch (_0x119122) {
...
zokou({
  ...
  try {
    if (!_0xea7c04 || _0xea7c04.length === 0x0) {
      return _0x5e569a("Hello am *𝔹𝕃𝔸ℂ𝕂ℍ𝔸ℂ𝕂𝔼ℝ𝕊-V1.* AN AI DEVELOPED BY 𝔹𝕃𝔸ℂ𝕂ℍ𝔸ℂ𝕂𝔼ℝ𝕊.\n\n What help can I offer you today?");
    }
